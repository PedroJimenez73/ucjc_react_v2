...
import picFile from '../img/RLE_M3_13d.jpg';
            ...
            <div className="slide">
                ...
                <div className="flex">
                    ...
                    <div className="col-50">
                        <p>A través de las 9 divisiones del modelo Canvas puedes identificar y evaluar todos los componentes que forman parte de tu marca personal.</p>
                        <p><b>¡Utilízalo para valorar tu marca personal!</b></p>
                        <Link text={'<a href="https://drive.google.com/file/d/1EyRBTeVllEvI0djfReSK7oycpyCI6qG5/view?usp=sharing" target="_blank">Plantilla Business Model Canvas</a>'} />
                    </div>
                </div>
            </div>
        )
