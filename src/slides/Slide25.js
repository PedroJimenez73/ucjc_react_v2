            ...
            <div className="slide back">
                ...
                <div className="flex">
                    <div className="col-100">
                        <p>Pasemos al siguiente tema. ¿Y si lo que queremos es encontrar empleo o realizar unas prácticas? </p>
                        <p>Debemos marcar una ruta, conocer  los recursos, etc. </p>
                        <p>¡Veamos qué nos cuenta Lineth!  </p>                 
                    </div>
                </div>
                <div className="flex">
