...
import picFile from '../img/RLE_M3_15.jpg';
            ...
            <div className="slide">
                ...
                <div className="flex">
                    <div className="col-50">
                        <p>Cuando avanzamos en nuestra carrera es importante que podamos establecer un <b>plan de acción</b> para conseguir experiencia laboral y construir las herramientas que nos permitirán acercarnos a nuestro mercado laboral objetivo.</p>
                        <p>En esta sección trabajaremos en la elaboración de un plan de búsqueda de oportunidades laborales, cómo desarrollar un CV atractivo y crear o mejorar un perfil en LinkedIn.</p>
                    </div>
