...
import picFile from '../img/RLE_M3_18.jpg';
            ...
            <div className="slide">
                ...
                <div className="flex">
                    <div className="col-50">
                        <p>En el caso de las páginas web de empresas, debes registrarte, crear un usuario y llenar diversos campos con tu información personal, de esta manera podrás ingresar a la base de datos de la empresa.</p>
                    </div>
