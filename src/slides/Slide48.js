...
class Slide extends Component {
    ...
    render() {
        ...
        const image = {
            src: picFile,
            alt: 'imagen',
            footText: 'Recomendaciones para una entrevista laboral: antes, durante y después. Recuperado de UTEC Career Services.'
        };
            ...
            <div className="slide">
                ...
                <div className="flex">
                    <div className="col-50">
                        <p>A continuación, te damos algunas recomendaciones para el antes, durante y después de una entrevista laboral.</p>
                    </div>
