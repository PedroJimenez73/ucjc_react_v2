...
import picFile from '../img/57.jpg';
...
<p>Para responder preguntas por competencias, debes familiarizarte con la metodología STAR, acrónimo de:</p>

<ul className="regular tempor">
	<li><b>S (Situación)</b></li>
	<li><b>T (Tarea)</b></li>
	<li><b>A (Acción)</b></li>
	<li><b>R (Resultado)</b></li>
</ul>

<p className="fade-five m-t">La cual consiste en brindar la descripción completa de una conducta a través de la descripción de una situación, tarea o rol, acciones emprendidas para lograr la tarea y los resultados derivados de las mismas, relativos a un suceso pasado.</p>
