            ...
            <div className="slide back">
                ...
                <div className="flex">
                    <div className="col-100">
                        <p>
                            ¡Ya casi estamos al final!¡Nos queda una última práctica que te ayudará a conseguir prácticas preprofesionales.
                        </p>

                        <p>
                            ¡Veamos el paso a paso de esta actividad práctica!
                        </p>
                        <p>
                            ¡Éxitos!
                        </p>
