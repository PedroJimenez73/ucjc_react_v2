            ...
            <div className="slide back">
                ...
                <div className="flex">
                    <div className="col-100">
                        <p>Hablemos ahora de la entrevista laboral. Qué debemos conocer sobre ella, cómo prepararla y lo que es más importante, ¡cómo superarla con éxito! </p>
                        <p>¡Interesante! ¡Veámoslo! </p>      
                    </div>
                </div>
                <div className="flex">
