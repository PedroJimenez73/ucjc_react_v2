            ...
            <div className="slide back">
                ...
                <div className="flex">
                    <div className="col-100">
                        <p>Comencemos con el primer tema <i>Marketing profesional.</i> Seguramente te estarás preguntando…  </p>
                        <p>¿Para que necesito yo esto? </p>
                        <p>Y si te digo que gracias a ello puedes obtener un empleo, un ascenso, crear tu propia empresa… </p>
                        <p>Interesante, ¿verdad? </p>
                        <p>¡Escuchemos a nuestra especialista! </p>
                    </div>
                </div>
                <div className="flex">
